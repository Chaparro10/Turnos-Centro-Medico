...
import { columnsMedicos, columnsPacientes, medicos, pacientes } from "@/utils";
...
export default function PacienteTable() {
  ...
  const [data, setData] = useState({});
    ...
    const columns: columnsPacientes[] = [
    ...
    const espes=()=>{
      const datos=   pacientes.map((item)=>createData(item.id,item.user.name,item.user.email,setOpen,setData));
      return datos;
     }
